...
Author: Jhye O'Meley
Email: jhyeomeley1@icloud.com
Website: https://github.com/Jhyetech
...
pygame.display.set_caption('RevVision ')
...
def virtualDashIntro():
    text = small_font.render("WELCOME TO VIRTUAL DASH", True, red)
...
def virtDash():
    ...
    screen.blit(needle_rotated, (screen.get_width() / 2 - int(needle_rotated.get_width() / 2), 305 - int(needle_rotated.get_height() / 2)))
    if rpm < 3500:
