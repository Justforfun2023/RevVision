...
class button():
    ...
    def draw_button(self):
        ...
        pygame.draw.line(self.screen, red, (self.x, self.y), (self.x + self.width, self.y), 2)
        pygame.draw.line(self.screen, red, (self.x, self.y), (self.x, self.y + self.height), 2)
        pygame.draw.line(self.screen, white, (self.x, self.y + self.height), (self.x + self.width, self.y + self.height), 2)
        pygame.draw.line(self.screen, white, (self.x + self.width, self.y), (self.x + self.width, self.y + self.height), 2)
